        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="password" name="password" required minlength="8" placeholder="••••••••" class="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:border-amber-400 focus:outline-none" />
                </div>
                <div>
                    <label class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">Konfirmasi Sandi</label>
                    <input type="password" name="password_confirmation" required minlength="8" placeholder="••••••••" class="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:border-amber-400 focus:outline-none" />
                </div>
            </div>
    ...
    <div class="bg-[#0c1017] border border-white/10 rounded-3xl max-w-lg w-full p-6 sm:p-7 shadow-2xl space-y-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <form id="formEditUser" action="" method="POST" class="space-y-4">
            ...
            <div class="p-3.5 rounded-2xl bg-white/[0.02] border border-white/5 space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <input type="password" name="password" minlength="8" placeholder="Sandi Baru (opsional)" class="w-full p-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:border-amber-400 focus:outline-none" />
                    </div>
                    <div>
                        <input type="password" name="password_confirmation" minlength="8" placeholder="Konfirmasi Sandi Baru" class="w-full p-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:border-amber-400 focus:outline-none" />
                    </div>
                </div>
            </div>
