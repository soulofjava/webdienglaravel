        ...
        <div class="glass-panel p-8 sm:p-10 rounded-3xl border border-white/10 shadow-2xl backdrop-blur-2xl">
            ...
            <div class="flex flex-col items-center text-center mb-8">
                ...
                <p class="text-xs text-slate-400 mt-1 max-w-xs">
                    Silakan masukkan kredensial resmi untuk mengelola identitas, SEO, dan konten {{ $settings->site_name }}.
                </p>
            </div>
            ...
            @if (session('info'))
                <div class="mb-6 p-4 rounded-2xl bg-sky-500/15 border border-sky-500/40 text-sky-300 text-xs flex items-center gap-2.5">
